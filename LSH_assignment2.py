...
if __name__ == '__main__':
    ...
    start_time = tm.time()
    docIdList, docsAsShingleSets, allShingles = shingling() # Shingling returns the required data.
    ...
    print("Shingling , Minhashing and LSH took --- %s seconds --- \n\n" % (tm.time() - start_time))
    ...
    print("Finding Jaccard Similarity took --- %s seconds --- \n\n" % (tm.time() - start_time))    
    ...
    print(" Finding cosine --- %s seconds --- \n\n" % (tm.time() - start_time)) 
    ...
    print("Finding Euclidean Distance--- %s seconds ---" % (tm.time() - start_time))     
